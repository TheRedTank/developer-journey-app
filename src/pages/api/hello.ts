...
export default function handler(
  ...
  switch (name) {
    case "info": logInfo("user sent info", { key: "info" }); break;
    case "warn": logWarn("user sent warning", { key: "warn" }); break;
    case "error": logError("user sent error", { key: "error" }); break;
    default: logError(new Error(`user sent ${name}`), { key: "unknown" });
  }
